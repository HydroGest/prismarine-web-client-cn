...
class TitleScreen extends LitElement {
  ...
  render () {
    return html`
      ...
      <div class="menu">
        <pmui-button pmui-width="200px" pmui-label="快速进入" @pmui-click=${() => displayScreen(this, document.getElementById('play-screen'))}></pmui-button>
        ...
        <pmui-button pmui-width="200px" pmui-label="QQ 群" @pmui-click=${() => openURL('http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=7Fe2VPl0DgjPfREPRVALfSo6fKYCcwsE&authKey=MOOPJmI1fjAwdqy3oT7E05VOxbDLHzqVgyzRQ2I1nKj9eB8iGBPHV1hQk17JiyCQ&noverify=0&group_code=945228330')}></pmui-button>
        
      </div>

      <div class="bottom-info">
        <span>网页版基霸 MC</span>
        <span>一个在浏览器运行的网页版 Jiba Minecraft！基于 HydroGest/Prismarine_Web_Client_CN。</span>
      </div>
    `
  }
}
